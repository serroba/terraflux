...
compute per-gate flux client-side — a 3D flux globe, a 2D map, and a plain table, no
query server. Only aggregate data is shipped to the client. Rebuild the aggregate
artifacts with
